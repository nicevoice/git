...
class model_admin_answer extends model {
    ...
    function __construct() {
        ...
        $this->_fields = array('answerid', 'contentid', 'created', 'createdby', 'examtime', 'isfinish', 'right','ip', 'openid');
    ...
    function search($data, $contentid) {
        ...
        $export = loader::model('admin/export', 'exam');
    ...
    /*public function delete($answerid, $contentid = 0) {
        ...
        if ($answerid && $contentid) {
            ...
            $this->exam->set_dec('answers', "contentid=$contentid");
            return TRUE;
        }
        return FALSE;
    }*/
