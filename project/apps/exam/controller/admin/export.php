 ...
 * @aca whole 导出
 */
final class controller_admin_export extends exam_controller_abstract
{
	private $exam, $question, $answer, $answer_record, $answer_option;
	...
	function index()
	{
	    ...
	    $examname = $this->exam->get($contentid,'title');
	    $title = '题库_'.(is_null($questionid)?$examname['title']:$examname['title'].'_'.$titlekeys[$questionid]).'.xls';
    ...
    public function  import91question()
    {
