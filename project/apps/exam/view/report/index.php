...
<div>
	<div class="f_l w_80 tag_list_2" style="height:600px;">
		<ul>
			<li><a href="?app=exam&controller=report&action=index&contentid=<?=$contentid?>" class="all_report_title s_6">全局报表</a></li>
	...
	<div id="report_list" style="margin-left:100px;" class="cat_m_r">
	    <div class="table_foot">
		  <div class="f_l">目前共有<span class="c_red"><?=$answers?></span>人参与</div><div class="f_r"><a href="javascript:;" onclick="exam.exportdata(<?=$contentid?>);">导出为EXCEL</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:;" onclick="window.print()" class="print">打印</a></div>
		</div>
		<div class="mar_t_10">
<?php 
$i = 1;
