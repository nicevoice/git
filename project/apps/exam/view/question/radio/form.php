...
<dd><input type="radio" name="option[]" value="<?=$o['optionid']?>" class="bdr_5" /> <?=$o['name']?><?php if (in_array($o['optionid'], explode(',', $answer))){?><b style="color: limegreen; margin-left: 10px;">答案</b><?php }?></dd>
<?php }?>
</dl>