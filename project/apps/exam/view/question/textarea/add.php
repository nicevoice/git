<form id="textarea_add"  method="post" action="?app=<?=$app?>&controller=<?=$controller?>&action=<?=$action?>">
	...
	<table border="0" cellspacing="0" cellpadding="0" class="table_form">
	  ...
	  <tr>
		<th>宽度：</th>
		<td><input type="text" name="width" id="width" size="3" value="400" /> px</td>
	  </tr>
	  <tr>
		<th>高度：</th>
		<td><input type="text" name="height" id="height" size="3" value="150" /> px</td>
	  </tr>
	  <tr>
		<th>最大字符数：</th>
