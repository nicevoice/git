...
<div class="tag_1">
	<ul class="tag_list">
		<li><a href="?app=exam&controller=exam&action=view&contentid=<?=$contentid?>" class="s_3">查看</a></li>
<?php 
...
if($status == 6 && priv::aca('exam', 'report', 'index')) {
?>
		<li><a href="?app=exam&controller=report&action=index&contentid=<?=$contentid?>">分析报告</a></li>
<?php 
}
?>
	</ul>
...
<div class="bg_2">
	<div class="f_l w_600 mar_r_8">
	  ...
	  <?php $this->display('workflow/view_inc', 'system');?>
			<tr>
				<th>问卷题目：</th>
				<td><?=$questions?> 个　<a href="?app=exam&controller=question&action=index&contentid=<?=$contentid?>">设计问卷</a></td>
			</tr>
			<tr>
				<th>参与人数：</th>
				<td><?=$answers?> 人　<a href="?app=exam&controller=report&action=answer&contentid=<?=$contentid?>">查看记录&gt;&gt;</a></td>
			</tr>
			<tr>
				<th>时间限制：</th>
