	...
	<table border="0" cellspacing="0" cellpadding="0" class="table_form">
	  <tr>
        ...
        <tr>
            ...
            <td><?=property_once('subjectid','subjectid',$pro_ids['subjectid'])?> </td>
        </tr>
        <tr>
            <th width="70"><span class="c_red">*</span> 考点：</th>
            <td><?=property_once('knowledgeid','knowledgeid',$pro_ids['knowledgeid'])?> </td>
        </tr>
        <tr>
            <th width="70"><span class="c_red">*</span> 类型：</th>
            <td><?=property_once('qtypeid','qtypeid',$pro_ids['qtypeid'])?> </td>
        </tr>
        <tr>
