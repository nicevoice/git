...
<div id="dms_content" class="dms_content">
	<div class="dms_inner">
		<div class="bk_8"></div>
		<form id="picture_add" name="picture_add" method="POST" action="?app=dms&controller=picture&action=add">
			<table width="98%" border="0" id="tabledata" cellspacing="0" cellpadding="0"   class="table_form mar_l_8">
				<tr>
					...
					<td width="690"><?=element::title('title', $title, $color)?></td>
				</tr>
				<tr>
					<th> Tags：</th>
				...
				<tr>
					...
					<td>
						...
						<input class="button_style_1" id="imageEdit" type="button" style="float:left;display:none" name="" value="编辑图片" onclick="picture.edit();">
					</td>
				</tr>
				<tr>
					<th></th>
					<td>
						<div style="height: auto;" id="pictures">
						</div>
...
<th width="60"></th><td><input class="expandkey" type="text" name="expand[key][0]" value="变量名" onfocus="this.value == \'变量名\' && (this.value = \'\')" onblur=" this.value || (this.value = \'变量名\')" /><input class="expandvalue" type="text" name="expand[value][0]" value="值" onfocus="this.value == \'值\' && (this.value = \'\')" onblur=" this.value || (this.value = \'值\')" /><span class="remove" onclick="removeField(this);"></span></td>\
</tr>';
