...
<script type="text/javascript" src="<?=APP_URL?>js/tiny_mce/tiny_mce_popupfx.js"></script>
...
<script type="text/javascript" src="<?=APP_URL?>js/tiny_mce/utils/validate.js"></script>
<script type="text/javascript" src="<?=APP_URL?>js/tiny_mce/utils/editable_selects.js"></script>
<script type="text/javascript" src="<?=APP_URL?>js/tiny_mce/plugins/advimage/js/image.js"></script>
<link href="<?=APP_URL?>js/tiny_mce/plugins/advimage/css/advimage.css" rel="stylesheet" type="text/css" />
<link href="<?=APP_URL?>js/tiny_mce/plugins/advimage/css/style.css" rel="stylesheet" type="text/css" />
<style  type="text/css">
...
<body id="advimage" style="display: none">
    <form onsubmit="ImageDialog.insert();return false;" action="#"> 
		<div class="tabs tag_1" style="margin-top:5px;">
			<ul class="tag_list">
							...
							<tr>
								...
								<table border="0" cellspacing="0" cellpadding="0">
									<tr> 
									  ...
									  <td style="padding-left:5px"><div id="uploadimg" ></div></td>
									</tr>
								  </table></td>
							</tr>
							<tr>
						...
						<tr> 
							...
							<td rowspan="6" valign="top">
								<div class="alignPreview">
									<img id="alignSampleImg" src="<?=APP_URL?>js/tiny_mce/plugins/advimage/img/sample.gif" alt="示例图片" />
