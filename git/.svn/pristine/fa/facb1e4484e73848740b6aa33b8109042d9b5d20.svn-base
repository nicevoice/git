...
class model_dms_search_article extends model_dms_search
{
	...
	public function __construct()
	{
		...
		$this->_fields = array('articleid', 'title', 'source', 'author', 'description', 'content', 'createtime', 'updatetime', 'status', 'expand', 'tags');
		$this->_readonly = array('articleid');
	...
	private function search($ids, $words)
	{
		...
		$this->data = $this->select($where, $this->_primary.', title, source, author, description, createtime, updatetime, tags, quote');
